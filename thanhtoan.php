    ...
    <div class="thanhtoan3">
        ...
        <div class="thanhtoan3-content">
            ...
            <div class="total-price">
                <span>Tổng cộng: </span>
                <span id="totalPrice" class="_price"><?php echo $totalpricetemp + 30000 ?>đ</span>
            </div>
            <form action="" class="khuyenmai _formthanhtoan">
                <p class="_pinput">Nhập mã khuyễn mãi (Mã Coupon, Voucher)</p>
                <div class="code-khuyenmai">
                    <input class="_inputthanhtoan" type="text" placeholder="Nhập mã khuyễn mãi nếu có">
                    <div class="btn btn-dark code btnthanhtoan">Áp dụng</div>
                </div>
            </form>
            <div class="btn-bottom">
                <a href="?action=checkout"
                    class="btn btn-dark btnthanhtoan">Tiến hành thanh toán</a>
                <a href="index.php">
